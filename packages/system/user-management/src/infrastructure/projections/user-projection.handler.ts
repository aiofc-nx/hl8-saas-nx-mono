...
{
  constructor(
    private readonly userReadModelRepository: IUserReadModelRepository // TODO: 注入其他依赖 // private readonly logger: ILoggerService, // private readonly cacheService: ICacheService
  ) {}
